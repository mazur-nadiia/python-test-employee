...
class TestEmployee(unittest.TestCase):
    ...
    def test_fulltime_positive(self):
        employee = Employee.factory(Employee, "Fred Johnson", EmployeeType.EmployeeType.FULLTIME, 2.5)
    ...
    def test_temporary(self):
        employee = Employee.factory(Employee, "Laura Ashley", EmployeeType.EmployeeType.TEMPORARY, 3.5)
        self.assertEqual(employee.calculate_vacation(), None)
        employee.print_employee()
